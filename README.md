...
You can also check out `eflambda_std.h` that defines some standard lambda
calculus symbols like numbers (in Church encoding), booleans, logic, arithmetic, combinators, etc.
